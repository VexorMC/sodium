...
public interface VertexBufferWriter {
    /**
     * Converts a {@link BufferBuilder} into a {@link VertexBufferWriter}.
     *
     ...
     */
    static VertexBufferWriter of(BufferBuilder consumer) {
    ...
    /**
     * Converts a {@link BufferBuilder} into a {@link VertexBufferWriter} if possible.
     *
     * @param consumer The vertex consumer to create a writer for
     ...
     */
    @Nullable
    static VertexBufferWriter tryOf(BufferBuilder consumer) {
        if (consumer instanceof VertexBufferWriter writer && writer.canUseIntrinsics()) {
            return writer;
        }
    ...
    private static RuntimeException createUnsupportedVertexConsumerThrowable(BufferBuilder consumer) {
    ...
    /**
     * If this {@link VertexBufferWriter} passes through data to nested {@link BufferBuilder} implementations,
