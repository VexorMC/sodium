...
public interface MaterialFinder extends MaterialView {
	 ...
	 * {@linkplain BakedModel#useAmbientOcclusion() the model uses ambient occlusion} and the block has
	 * {@linkplain Block#getLightLevel() a luminance of 0}. Set to {@link TriState#TRUE} or {@link TriState#FALSE}
