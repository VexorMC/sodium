...
public interface FabricBakedModel {
	 ...
	 * {@link net.minecraft.client.render.entity.ItemEntityRenderer}, after being updated, can be reused an arbitrary amount of times and
	 * produce the same result each time. To depend on additional context, such as the
	 * {@link ItemStack} or {@link net.minecraft.client.render.model.json.ModelTransformation.Mode}, it is recommended to use a custom
	 * {@link net.minecraft.client.render.item.ItemModels}, capture the necessary context such that it cannot be modified externally
