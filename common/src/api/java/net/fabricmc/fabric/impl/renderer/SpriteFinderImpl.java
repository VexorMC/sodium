    ...
    private class Node {
        ...
        void add(Sprite sprite) {
            if (sprite.getMinU() < 0 - EPS || sprite.getMaxU() > 1 + EPS || sprite.getMinV() < 0 - EPS || sprite.getMaxV() > 1 + EPS) {
                ...
                if (badSpriteCount++ < 5) {
                    ...
                    LOGGER.error(errorMessage, sprite.getName(), sprite.getMinU(), sprite.getMaxU(), sprite.getMinV(), sprite.getMaxV());
                }
        ...
        private Sprite findInner(Object quadrant, float u, float v) {
            if (quadrant instanceof Sprite) {
                ...
                return spriteAtlasTexture.getSprite(SpriteAtlasTexture.MISSING);
            }
        }
    }
