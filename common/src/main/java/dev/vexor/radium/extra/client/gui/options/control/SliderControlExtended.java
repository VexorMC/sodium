...
public class SliderControlExtended implements Control<Integer> {
    ...
    private static class Slider extends ControlElement<Integer> {
        ...
        private void renderSlider() {
            ...
            this.drawRect((int) thumbX, sliderY, (int) (thumbX + (THUMB_WIDTH * 2)), sliderY + sliderHeight, 0xFFFFFFFF);
            this.drawRect(sliderX, (int) trackY, sliderX + sliderWidth, (int) (trackY + TRACK_HEIGHT), 0xFFFFFFFF);

            Text label = this.displayIntValueWhileSliding ? new LiteralText(String.valueOf(this.getIntValue())) : this.formatter.format(this.option.getValue());
