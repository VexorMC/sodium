...
public class FireworksHelper {
    ...
    private static final Identifier PARTICLE_PROPERTIES = TexturePackAPI
    ...
    public static int getFXLayer(Particle entity) {
        if (enable && (entity instanceof FireworksSparkParticle.Flash || entity instanceof FireworksSparkParticle.Explosion)) {
            return EXTRA_LAYER;
        } else {
