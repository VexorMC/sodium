...
public class ScrollableFrame extends AbstractFrame {
    ...
    @Override
    public boolean mouseScrolled(double mouseX, double mouseY, double hA, double amount) {
        return super.mouseScrolled(mouseX, mouseY, hA, amount) || (this.canScrollHorizontal && this.horizontalScrollBar.mouseScrolled(mouseX, mouseY, hA, amount)) || (this.canScrollVertical && this.verticalScrollBar.mouseScrolled(mouseX, mouseY, hA, amount));
    }
