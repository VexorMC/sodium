...
public interface VertexDrain {
     ...
     * is always implemented on a given BufferBuilder, this is simply implemented as a cast internally.
     ...
     */
    <T extends VertexSink> T oldium$createSink(VertexType<T> factory);
}
