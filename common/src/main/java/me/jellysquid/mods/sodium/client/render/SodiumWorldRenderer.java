...
public class SodiumWorldRenderer implements ChunkStatusListener {
    ...
    public void updateChunks(CullingCameraView frustum, float ticks, boolean hasForcedFrustum, int frame, boolean spectator) {
        ...
        if (ShadowRenderingState.areShadowsCurrentlyBeingRendered()) {
            // Forces the comparison with the current camera to return false, making SodiumWorldRenderer
    ...
    private void initRenderer() {
        ...
        this.chunkRenderBackend = createChunkRenderBackend(device, opts, BlockRenderingSettings.INSTANCE.shouldUseExtendedVertexFormat()
                ? IrisModelVertexFormats.MODEL_VERTEX_XHFP : vertexFormat);
