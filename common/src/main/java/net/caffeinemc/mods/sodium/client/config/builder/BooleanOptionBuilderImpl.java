...
class BooleanOptionBuilderImpl extends StatefulOptionBuilderImpl<BooleanOption, Boolean> implements BooleanOptionBuilder {
    ...
    @Override
    public BooleanOptionBuilder setName(Text name) {
        super.setName(name);
        return this;
    }
    ...
    @Override
    public BooleanOptionBuilder setTooltip(Text tooltip) {
        super.setTooltip(tooltip);
        return this;
    }

    @Override
    public BooleanOptionBuilder setTooltip(Function<Boolean, Text> tooltip) {
        super.setTooltip(tooltip);
        return this;
    }
