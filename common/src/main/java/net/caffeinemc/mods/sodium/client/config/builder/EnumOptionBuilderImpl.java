...
class EnumOptionBuilderImpl<E extends Enum<E>> extends StatefulOptionBuilderImpl<EnumOption<E>, E> implements EnumOptionBuilder<E> {
    ...
    @Override
    public EnumOptionBuilder<E> setElementNameProvider(Function<E, Text> provider) {
    ...
    @Override
    public EnumOptionBuilder<E> setTooltip(Text tooltip) {
        super.setTooltip(tooltip);
        return this;
    }

    @Override
    public EnumOptionBuilder<E> setTooltip(Function<E, Text> tooltip) {
        super.setTooltip(tooltip);
        return this;
    }
