...
public class EnumOption<E extends Enum<E>> extends StatefulOption<E> {
    ...
    private final Function<E, Text> elementNameProvider;

    public EnumOption(Identifier id, Collection<Identifier> dependencies, Text name, DependentValue<Boolean> enabled, StorageEventHandler storage, Function<E, Text> tooltipProvider, OptionImpact impact, EnumSet<OptionFlag> flags, DependentValue<E> defaultValue, OptionBinding<E> binding, Class<E> enumClass, DependentValue<Set<E>> allowedValues, Function<E, Text> elementNameProvider) {
    ...
    public Text getElementName(E element) {
