...
public class IntegerOption extends StatefulOption<Integer> {
    ...
    public IntegerOption(Identifier id, Collection<Identifier> dependencies, Text name, DependentValue<Boolean> enabled, StorageEventHandler storage, Function<Integer, Text> tooltipProvider, OptionImpact impact, EnumSet<OptionFlag> flags, DependentValue<Integer> defaultValue, OptionBinding<Integer> binding, DependentValue<Range> range, ControlValueFormatter valueFormatter) {
    ...
    public Text formatValue(int value) {
