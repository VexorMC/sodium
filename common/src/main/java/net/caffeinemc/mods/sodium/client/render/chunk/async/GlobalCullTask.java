...
public class GlobalCullTask extends CullTask<GlobalCullResult> {
    ...
    public GlobalCullTask(Viewport viewport, float buildDistance, int frame, OcclusionCuller occlusionCuller, boolean useOcclusionCulling, Long2ReferenceMap<RenderSection> sectionByPosition, CullType cullType, World level) {
