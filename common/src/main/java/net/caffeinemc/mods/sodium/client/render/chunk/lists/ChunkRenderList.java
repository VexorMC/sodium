...
public class ChunkRenderList {
    ...
    public void prepareForRender(SectionPos cameraPos, SortItemsProvider sortItemsProvider) {
        ...
        int relativeCameraSectionX = MathHelper.clamp(cameraPos.getX() - this.region.getChunkX(), -1, RenderRegion.REGION_WIDTH);
        int relativeCameraSectionY = MathHelper.clamp(cameraPos.getY() - this.region.getChunkY(), -1, RenderRegion.REGION_HEIGHT);
        int relativeCameraSectionZ = MathHelper.clamp(cameraPos.getZ() - this.region.getChunkZ(), -1, RenderRegion.REGION_LENGTH);
    ...
    private void sortSections(int relativeCameraSectionX, int relativeCameraSectionY, int relativeCameraSectionZ, SortItemsProvider sortItemsProvider) {        relativeCameraSectionX = MathHelper.clamp(relativeCameraSectionX, 0, RenderRegion.REGION_WIDTH - 1);
        relativeCameraSectionY = MathHelper.clamp(relativeCameraSectionY, 0, RenderRegion.REGION_HEIGHT - 1);
        relativeCameraSectionZ = MathHelper.clamp(relativeCameraSectionZ, 0, RenderRegion.REGION_LENGTH - 1);
