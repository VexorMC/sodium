...
public class FallbackVisibleChunkCollector extends TaskCollectingTree implements CoordinateSectionVisitor {
    ...
    public FallbackVisibleChunkCollector(Viewport viewport, float buildDistance, int frame, Long2ReferenceMap<RenderSection> sectionByPosition, RenderRegionManager regions, World level) {
