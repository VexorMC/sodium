...
public class BakedModelEncoder {
    ...
    private static final boolean MULTIPLY_ALPHA = true;

    public static void writeQuadVertices(VertexBufferWriter writer, dev.vexor.radium.compat.mojang.blaze3d.vertex.PoseStack.Pose matrices, ModelQuadView quad, int color, int light, int overlay, boolean colorize) {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            writer.sodium$push(stack, buffer, 4, EntityVertex.FORMAT);
        }
    }
