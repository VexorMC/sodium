...
public class ModelCuboid {
    ...
    private static void reverseVertices(int[] vertices, long[] texCoords) {
        for (int faceIndex = 0; faceIndex < NUM_CUBE_FACES; faceIndex++) {
            ...
            swap(vertices, vertexOffset + 0, vertexOffset + 3);
            swap(vertices, vertexOffset + 1, vertexOffset + 2);

            swap(texCoords, vertexOffset + 0, vertexOffset + 3);
            swap(texCoords, vertexOffset + 1, vertexOffset + 2);
        }
    }
