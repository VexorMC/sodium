...
public class HorizonRenderer {
	...
	public HorizonRenderer() {
		currentRenderDistance = MinecraftClient.getInstance().options.getEffectiveRenderDistance();
	...
	public void renderHorizon(Matrix4fc modelView, Matrix4fc projection, ShaderInstance shader) {
		if (currentRenderDistance != MinecraftClient.getInstance().options.getEffectiveRenderDistance()) {
			currentRenderDistance = MinecraftClient.getInstance().options.getEffectiveRenderDistance();
			rebuildBuffer();
		}
