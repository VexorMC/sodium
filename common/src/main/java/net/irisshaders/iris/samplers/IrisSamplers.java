...
public class IrisSamplers {
	...
	public static void addLevelSamplers(SamplerHolder samplers, WorldRenderingPipeline pipeline, net.minecraft.client.texture.AbstractTexture whitePixel, boolean hasTexture, boolean hasLightmap, boolean hasOverlay) {
		if (hasTexture) {
