...
public class StandardMacros {
	...
	public static String getOsString() {
		switch (Platform.get()) {
            ...
            case FREEBSD: // Note: Optifine doesn't have a macro for FreeBSD. https://github.com/sp614x/optifine/blob/9c6a5b5326558ccc57c6490b66b3be3b2dc8cbef/OptiFineDoc/doc/shaders.txt#L709-L714
			default:
