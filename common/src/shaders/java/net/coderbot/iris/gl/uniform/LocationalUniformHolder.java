...
public interface LocationalUniformHolder extends UniformHolder {
	...
	@Override
	default LocationalUniformHolder uniformVanilla3f(UniformUpdateFrequency updateFrequency, String name, Supplier<org.joml.Vector3f> value) {
	...
	@Override
	default LocationalUniformHolder uniformJomlMatrix(UniformUpdateFrequency updateFrequency, String name, Supplier<org.joml.Matrix4f> value) {
