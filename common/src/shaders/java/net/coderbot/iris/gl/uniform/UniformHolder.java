...
public interface UniformHolder {
	...
	UniformHolder uniformVanilla3f(UniformUpdateFrequency updateFrequency, String name, Supplier<org.lwjgl.util.vector.Vector3f> value);
	...
	UniformHolder uniformMatrix(UniformUpdateFrequency updateFrequency, String name, Supplier<org.lwjgl.util.vector.Matrix4f> value);
