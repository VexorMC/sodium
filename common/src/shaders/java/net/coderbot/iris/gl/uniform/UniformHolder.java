...
public interface UniformHolder {
	...
	UniformHolder uniformVanilla3f(UniformUpdateFrequency updateFrequency, String name, Supplier<org.joml.Vector3f> value);
	...
	UniformHolder uniformJomlMatrix(UniformUpdateFrequency updateFrequency, String name, Supplier<org.joml.Matrix4f> value);
