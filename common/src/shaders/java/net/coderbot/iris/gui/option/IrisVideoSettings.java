...
public class IrisVideoSettings {
	...
	private static final Component DISABLED_TOOLTIP = new TranslatableText("options.iris.shadowDistance.disabled");
	private static final Component ENABLED_TOOLTIP = new TranslatableText("options.iris.shadowDistance.enabled");
