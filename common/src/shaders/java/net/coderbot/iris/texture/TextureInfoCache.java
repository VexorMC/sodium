...
public class TextureInfoCache {
	...
	public static class TextureInfo {
		...
		private int fetchLevelParameter(int pname) {
			...
			int previousTextureBinding = GlStateManager.getInteger(GL20C.GL_TEXTURE_BINDING_2D);

			// Bind this texture and grab the parameter from it.
			GlStateManager.bindTexture(id);
			int parameter = GlStateManager.getTexLevelParameter(GL20C.GL_TEXTURE_2D, 0, pname);
